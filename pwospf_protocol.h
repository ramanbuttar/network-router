...
#define SEQUENCE_RANGE 5		/* Range for LSU Sequence Numbers */
...
struct ospfv2_hello
{
	...
	struct ip 				ip_hdr;
    struct ospfv2_hdr 		header;
    struct ospfv2_hello_hdr hello;
}__attribute__ ((packed));

struct ospfv2_lsu_pkt
{
	struct sr_ethernet_hdr  ether;
	struct ip 				ip_hdr;
	struct ospfv2_hdr 		header;
    struct ospfv2_lsu_hdr 	lsu_header;
}__attribute__ ((packed));
